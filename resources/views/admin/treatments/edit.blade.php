...
<div class="container-fluid" style="max-width: 800px;">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-8">
            ...
            <h2 class="mb-0 mt-2" style="font-family: 'Playfair Display', serif; font-size: 2.2rem;">Edit Treatment</h2>
        </div>
    ...
    <div class="card">
        <div class="card-header py-3">
            <h6 class="mb-0" style="font-weight: 600; font-family: 'Jost', sans-serif; letter-spacing: 0.5px;">
                <i class="fas fa-edit me-2" style="color: var(--primary);"></i>Form Edit Treatment
            </h6>
        </div>
            ...
            <form action="{{ route('admin.treatments.update', $treatment) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" 
                           value="{{ old('name', $treatment->name) }}" placeholder="Contoh: Fast Clean" required 
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control @error('price') is-invalid @enderror" id="price" name="price" 
                               value="{{ old('price', $treatment->price) }}" placeholder="50000" min="0" required 
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" 
                              ...
                              style="background-color: #2a2a2a; border: 1px solid rgba(255,255,255,0.1); color: #e0e0e0;">{{ old('description', $treatment->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-4">
                    <div class="form-check form-switch" style="padding-left: 2.5em;">
                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" 
                               {{ old('is_active', $treatment->is_active ?? '1') == '1' ? 'checked' : '' }}
