...
<div class="container-fluid" style="max-width: 800px;">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-8">
            ...
            <h2 class="mb-0 mt-2" style="font-family: 'Playfair Display', serif; font-size: 2.2rem;">Edit Pengeluaran</h2>
        </div>
    ...
    <div class="card">
        <div class="card-header py-3">
            <h6 class="mb-0" style="font-weight: 600; font-family: 'Jost', sans-serif; letter-spacing: 0.5px;">
                <i class="fas fa-edit me-2" style="color: var(--primary);"></i>Form Edit Pengeluaran
            </h6>
        </div>
            ...
            <form action="{{ route('admin.expenses.update', $expense) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control fw-bold text-danger @error('amount') is-invalid @enderror" id="amount" name="amount" 
                               value="{{ old('amount', explode('.', $expense->amount)[0]) }}" placeholder="150000" min="0" required 
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" 
                              ...
                              style="background-color: #2a2a2a; border: 1px solid rgba(255,255,255,0.1); color: #e0e0e0;">{{ old('description', $expense->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                    ...
                    <div class="d-flex flex-wrap gap-4">
                        ...
                        <div class="form-check custom-radio">
                            <input class="form-check-input" type="radio" name="payment_method" id="method_{{ Str::slug($method) }}" 
                                   value="{{ $method }}" {{ old('payment_method', $expense->payment_method) == $method ? 'checked' : '' }} required>
